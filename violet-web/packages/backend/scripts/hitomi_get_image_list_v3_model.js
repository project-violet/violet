...
// Placeholders %%gg.m% and %%gg.b% are replaced at runtime with values from gg.js
// %%gg.s% is replaced with the gg.s function body
...
function hitomi_get_image_list() {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    // Full image: no base param → subdomain becomes w1/w2 (webp) or a1/a2 (avif)
    if (file["hasavif"] == 1) {
    ...
    // Thumbnails: base='tn' → subdomain becomes atn/btn
    if (file["haswebp"] == 1) {
