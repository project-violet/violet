...
test('aggregates user activity by local calendar day and type', () => {
  ...
  db.exec(`
    CREATE TABLE ArticleReadLog (Id INTEGER, Article TEXT, DateTimeStart TEXT);
    ...
    INSERT INTO ArticleReadLog VALUES
      (1, '10', '2026-07-10T08:00:00.000Z'),
      (2, '10', '2026-07-10T09:00:00.000Z'),
      (3, '20', '2026-07-11T08:00:00.000Z');
  ...
  assert.deepEqual(result.topArticles.slice(0, 3), [
    { articleId: '10', reads: 2, bookmarks: 1, crops: 0, downloads: 0, total: 3 },
    { articleId: '20', reads: 1, bookmarks: 0, crops: 1, downloads: 0, total: 2 },
    { articleId: '30', reads: 0, bookmarks: 0, crops: 0, downloads: 1, total: 1 },
  ]);
