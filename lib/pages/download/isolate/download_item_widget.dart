...
import 'package:violet/pages/download/isolate/download_item_menu.dart';
import 'package:violet/pages/download/isolate/download_routine.dart';
import 'package:violet/pages/viewer/viewer_page.dart';
import 'package:violet/pages/viewer/viewer_page_provider.dart';
import 'package:violet/settings/settings.dart';
import 'package:violet/widgets/toast.dart';

class SecondDownloadItemWidget extends StatefulWidget {
  final double width;
  final DownloadItemModel item;
  bool download;
  final VoidCallback refeshCallback;

  SecondDownloadItemWidget({
    this.width,
    this.item,
    this.download,
    this.refeshCallback,
  ...
  @override
  _SecondDownloadItemWidgetState createState() =>
      _SecondDownloadItemWidgetState();
}

class _SecondDownloadItemWidgetState extends State<SecondDownloadItemWidget>
  ...
  _downloadProcedure() {
    Future.delayed(Duration(milliseconds: 500)).then((value) async {
      ...
      var routine = SecondDownloadRoutine(widget.item, () => setState(() {}));
    ...
    return GestureDetector(
      ...
      onLongPress: () async {
        ...
        var v = await showDialog(
          context: context,
          builder: (BuildContext context) => SecondDownloadImageMenu(),
        );
